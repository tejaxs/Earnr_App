          ...
          {loading ? (
                ...
                >
                  <div className="relative">
                    ...
                    <img
                      src={da?.image}
                      alt=".."
                      className="w-full md:h-[130px] h-[100px]"
                    />
                  </div>
            ...
            <div>
              {cat !== "Earnr Activities" && (
                <div
                  className="md:w-[210px] w-[200px] cursor-default snap-center bg-black text-white rounded-lg shadow-lg border border-gray-300 
